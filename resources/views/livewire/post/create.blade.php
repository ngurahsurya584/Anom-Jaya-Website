        ...
        <form wire:submit.prevent="store">
            <div class="form-group">
                ...
                <input type="text" wire:model="code_member"
                    class="form-control @error('code_member') is-invalid @enderror" placeholder="Masukkan Code Member">
                @error('code_member')
            ...
            <div class="form-group">
                ...
                <input type="text" wire:model="nama_member"
                    class="form-control @error('nama_member') is-invalid @enderror" placeholder="Masukkan Nama Member">
                @error('nama_member')
                    <span class="invalid-feedback">
                        {{ $message }}
                    </span>
