                        ...
                        <form action="/update/{{ $barang->id_barang }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nama_barang" type="name" class="form-control"
                                    value="{{ $barang->nama_barang }}" id="nama_barang" aria-describedby="namelHelp"
                            ...
                            <div class="form-group">
                                ...
                                <input name="harga_barang" type="number" class="form-control"
                                    value="{{ $barang->harga_barang }}" id="harga_barang"
                            ...
                            <div class="form-group">
                                ...
                                <input name="deskripsi_barang" type="text" class="form-control"
                                    value="{{ $barang->deskripsi_barang }}" id="deskripsi_barang" rows="3">
                            ...
                            <div class="form-group">
                                ...
                                <input name="foto_barang" type="file" class="form-control-file"
                                    value="{{ $barang->foto_barang }}" id="foto_barang">
