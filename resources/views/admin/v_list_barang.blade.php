            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <a href="/input" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                                ...
                                @foreach ($barang as $k)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('template_user/') }}/assets/img/portofolio/{{ $k->foto_barang }}"
                                                alt="" width="150px"></td>
                                        <td>
                                            <a href="/edit/{{ $k->id_barang }}"><img
                                                    src="{{ asset('template_admin/') }}/img/edit.png" alt=""></a>
                                            <form action="/delete/{{ $k->id_barang }}" method="POST" class="d-inline">
                                                @csrf
                                                <input type="hidden" name="method" value="DELETE">
                                                <button type="submit" onclick="return confirm('apakah anda yakin?');"><img
                                                        src="{{ asset('template_admin/') }}/img/delete.png" alt="">
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
